...
const HeaderTasks: React.FC = () => {
    ...
    const weekdayName: string[] = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"];

    const todayDate = `${year}, ${monthName[month].slice(0, 3)} ${day.toString().padStart(2, "0")} ${weekdayName[weekday]}`;
